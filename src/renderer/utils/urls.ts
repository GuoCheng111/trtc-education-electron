    ...
    return axios
        ...
        .then(response => {
            ...
            if (response.data.code !== 200 && response.data.code !== '200') {
                throw new CustomError(response.data.code, response.data.message || response.data.msg);
            } else {
...
export const AxiosPost = (
    ...
    return axios
        ...
        .then(response => {
            ...
            if (response.data.code !== 200 && response.data.code !== '200') {
                throw new CustomError(response.data.code, response.data.message || response.data.msg || response.data.reason);
            } else {
                return response.data;
            }
        })
